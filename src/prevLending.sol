...
//         collateral.borrowableAmount = ethToUsdc *  _ltv / _BASE_POINT;
//         require(collateral.borrowableAmount >= amount + collateral.borrowedAmount, "Amount greater than the borrowable amount" );
...
//         return (amount * 1000001009 ** n) / (1000000000 ** n);
//      }
